...
!(function (t, n) {
    ...
    function ew(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (nw(o) + nw(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function rw(t, n) {
        var e = t._x1 - t._x0;
    ...
    (Mw.prototype = xw.prototype),
                ...
                if ((u || (u = f = c()), h < l && ((s = h), (h = l), (l = s)), h > Mm))
                    if (g > Sm - Mm)
                        u.moveTo(h * _m(d), h * xm(d)),
                            u.arc(0, 0, h, d, p, !y),
                            l > Mm && (u.moveTo(l * _m(p), l * xm(p)), u.arc(0, 0, l, p, d, y));
                    else {
                        var v,
                            _,
                            b = d,
                        ...
                        if (S > Mm) {
                            var C = Em((S / l) * xm(A)),
                                P = Em((S / h) * xm(A));
                            (M -= 2 * C) > Mm ? ((x += C *= y ? 1 : -1), (w -= C)) : ((M = 0), (x = w = (d + p) / 2)),
                                (T -= 2 * P) > Mm
                                    ? ((b += P *= y ? 1 : -1), (m -= P))
                                    : ((T = 0), (b = m = (d + p) / 2));
                        }
                        ...
                        T > Mm
                            ? k > Mm
                                ? ((v = Dm(I, O, z, $, h, k, y)),
                                  ...
                                  k < E
                                      ? u.arc(v.cx, v.cy, k, vm(v.y01, v.x01), vm(_.y01, _.x01), !y)
                                      : (u.arc(v.cx, v.cy, k, vm(v.y01, v.x01), vm(v.y11, v.x11), !y),
                                        u.arc(
                                            0,
                                            0,
                                            h,
                                        ...
                                        u.arc(_.cx, _.cy, k, vm(_.y11, _.x11), vm(_.y01, _.x01), !y)))
                            ...
                            l > Mm && M > Mm
                                ? N > Mm
                                    ? ((v = Dm(D, R, q, U, l, -N, y)),
                                      ...
                                      N < E
                                          ? u.arc(v.cx, v.cy, N, vm(v.y01, v.x01), vm(_.y01, _.x01), !y)
                                          : (u.arc(v.cx, v.cy, N, vm(v.y01, v.x01), vm(v.y11, v.x11), !y),
                                            u.arc(
                                                0,
                                                0,
                                                l,
                                            ...
                                            u.arc(_.cx, _.cy, N, vm(_.y11, _.x11), vm(_.y01, _.x01), !y)))
                                    : u.arc(0, 0, l, w, x, y)
                                : u.lineTo(D, R);
                    }
                else u.moveTo(0, 0);
        ...
        (t.interpolateRainbow = function (t) {
            ...
            return (am.h = 360 * t - 100), (am.s = 1.5 - 1.5 * n), (am.l = 0.8 - 0.9 * n), am + "";
        }),
        ...
        (t.stack = function () {
            ...
            return (
                ...
                (i.order = function (t) {
                    return arguments.length
                        ? ((n = null == t ? hw : "function" == typeof t ? t : gm(Array.from(t))), i)
                        : n;
                }),
                (i.offset = function (t) {
